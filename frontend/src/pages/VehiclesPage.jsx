      ...
      <div className="p-8 flex flex-col gap-6 w-full">
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <div className="bg-[#f7f9fb] border-b border-[#e0e0e0] h-14 px-8 flex items-center">
            <div className="w-32 text-[#6e6e6e] font-semibold text-sm">
              Matrícula
            </div>
            <div className="flex-[2] text-[#6e6e6e] font-semibold text-sm">
              Vehículo
            </div>
            <div className="flex-[2] text-[#6e6e6e] font-semibold text-sm">
              Cliente
            </div>
            <div className="flex-1 text-[#6e6e6e] font-semibold text-sm">
              Tipo
            </div>
            <div className="flex-1 text-[#6e6e6e] font-semibold text-sm">
              Año
            </div>
            <div className="w-28 text-[#6e6e6e] font-semibold text-sm text-center">
              Acciones
            </div>
          </div>
          ...
          <div className="divide-y divide-[#e0e0e0]">
            {filteredVehicles.map((vehicle) => (
              <div
                ...
                className="px-8 py-4 flex items-center hover:bg-[#f7f9fb] transition-colors"
              >
                ...
                <div className="flex-1">
                  <span className="bg-[#f0f0f0] text-[#2c2c2c] text-xs font-medium px-3 py-1.5 rounded-full">
                    {vehicle.fuel_type}
                  </span>
                </div>
